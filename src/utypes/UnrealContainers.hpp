// This file is not under GPL license and is fully closed-source, copyright Fischsalat
// We only link to this file and do not derive/.
// https://github.com/Fischsalat/UnrealContainers/blob/master/UnrealContainers/UnrealContainersNoAlloc.h

/*
    Copyright (C) 2025 lunarlattice
    ...
    If you modify this Program, or any covered work, by linking or combining it with UnrealContainers (or a modified version of that library), containing parts covered by the terms of All Rights Reserved, the licensors of this Program grant you additional permission to convey the resulting work. {Corresponding Source for a non-source form of such a combination shall include the source code for the parts of UnrealContainers used as well as that of the covered work.}
...
namespace UC
{
	...
	public:
		...
		inline bool Remove(int32 Index)
		{
			...
			{
				/* NumElements was decremented, accessing i + 1 is safe */
				Data[i] = Data[i + 1];
			}
